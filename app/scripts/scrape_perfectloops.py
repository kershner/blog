...
def log():
    ...
    with open('/home/tylerkershner/app/templates/reddit_slideshow/perfectloops_log.txt', 'a') as log_file:
...
file_object = open('/home/tylerkershner/app/templates/reddit_slideshow/perfectloops_uls.txt', 'r+')
