...
def log():
    ...
    with open('/home/tylerkershner/app/templates/reddit_slideshow/surrealgifs_log.txt', 'a') as log_file:
...
file_object = open('/home/tylerkershner/app/templates/reddit_slideshow/surrealgifs_uls.txt', 'r+')
