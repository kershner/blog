...
target_subreddit = 'interestinggifs'
...
def log():
    ...
    with open('/home/tylerkershner/app/templates/reddit_slideshow/interestingifs_log.txt', 'a') as log_file:
...
file_object = open('/home/tylerkershner/app/templates/reddit_slideshow/interestinggifs_uls.txt', 'r+')
