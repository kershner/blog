...
def log():
    ...
    with open('/home/tylerkershner/app/templates/reddit_slideshow/%s_log.txt' % sys.argv[1], 'a') as log_file:
...
file_object = open('/home/tylerkershner/app/templates/reddit_slideshow/%s_urls.txt' % sys.argv[1], 'r+')
